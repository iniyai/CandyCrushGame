...
public class calibrateFall {

	private static final String OUTPUT_FILENAME = "calibratio.txt";
	...
	public static void main(String[] args) {
		...
		for (int bSize = 3; bSize <= 6; bSize++) {
			for (int dep = 2; dep <= 5; dep++) {
				...
				double nodeCount = Math.log10((double) nodes / 40) / dep / bSize;
				totalTimePerNode += timePerNode;
				totalNodeCount += nodeCount;
				// System.out.println(
				// "bsize, depth, timePerNode: " + bSize + " " + dep + " " +
